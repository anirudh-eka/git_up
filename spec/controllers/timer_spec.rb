...
describe TimerController do
  describe 'GET #show' do
    ...
    it 'sends the next event with a json request' do 
      ...
      expect(body).to eq({"next_event"=>{"name" => "Lunch", "start_time" => "2014-06-07T12:30:00.000-05:00", "venue"=> "The Westin Peachtree Plaza", "group_name"=>nil, "formatted_time" =>"12:30 PM"}})
    end
  end
end
